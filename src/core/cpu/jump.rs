...
impl CPU {
    ...
    // JP 指令 (C3, C2, CA, D2, DA, E9)
    pub fn jp(cpu: &mut CPU, addr: u16) -> CyclesType {
        // TODO: 實作 JP 指令
        12
    }
    ...
    // JR 指令 (18, 20, 28, 30, 38)
    pub fn jr(cpu: &mut CPU, offset: i8) -> CyclesType {
        // TODO: 實作 JR 指令
        8
    }
    ...
    // CALL 指令 (CD, C4, CC, D4, DC)
    pub fn call(cpu: &mut CPU, addr: u16) -> CyclesType {
        // TODO: 實作 CALL 指令
        12
    }
    ...
    // RET 指令 (C9, C0, C8, D0, D8)
    pub fn ret(cpu: &mut CPU) -> CyclesType {
        // TODO: 實作 RET 指令
        8
    }
    ...
    // RST 指令 (C7, CF, D7, DF, E7, EF, F7, FF)
    pub fn rst(cpu: &mut CPU, addr: u16) -> CyclesType {
        // TODO: 實作 RST 指令
        16
    }
}
