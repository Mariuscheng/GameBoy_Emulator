...
// CPU debug logging. Set to 1 to enable per-step logging for the CPU.
#ifndef GB_CPU_DEBUG
#define GB_CPU_DEBUG 0
#endif
...
public:
    ...
    void execute_load_instructions(uint8_t opcode); // Load instructions (switch-case)
    void execute_load_instructions_map(uint8_t opcode); // Load instructions (map-based)
...
private:
    ...
    void execute_stop_instruction();
    void execute_arithmetic_instructions(uint8_t opcode);
    void execute_logical_instructions(uint8_t opcode);
    void execute_inc_dec_instructions(uint8_t opcode);
    void execute_stack_instructions(uint8_t opcode);
    void execute_jump_instructions(uint8_t opcode);
    void execute_call_return_instructions(uint8_t opcode);
    void execute_rotate_instructions(uint8_t opcode);
    void execute_misc_instructions(uint8_t opcode);
